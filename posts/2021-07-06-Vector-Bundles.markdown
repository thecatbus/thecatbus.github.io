...
\end{align*} 
Then we can give an isomorphism $V\rightarrow \mathcal{O}(1)$ by mapping $(x_0:...:x_n:\lambda)$ to the linear map $\lambda\in \mathcal{O}(1)_{(x_0:...:x_n)}$. Henceforth we shall use the two realisations of $\mathcal{O}(1)$ interchangeably.
...
On the other hand if $F\in \mathbb{C}[X_0,...,X_n]$ is any homogeneous polynomial of degree $1$, then $F$ corresponds to the section $z\mapsto (z:F(z))$ of $V\subset \mathbb{P}^{n+1}$ (the degree $1$ condition ensures this section is well-defined). Thus the holomorphic sections of \(\mathcal{O}_{\mathbb{P}^n}(1)\) are precisely homogeneous degree 1 polynomials. 
